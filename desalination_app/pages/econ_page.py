"""
WT-Desal Lab — Economics Page. Light "Frost" theme.
"""
...
class EconPage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        ctk.CTkLabel(title_row, text="Economics", font=Fonts.H1,
        ...
        ctk.CTkLabel(badge, text="  Financial Analysis  ", font=Fonts.MICRO,
                     text_color=Colors.ACCENT).pack(padx=4, pady=2)

        ctk.CTkLabel(header, text="Evaluate project viability and cost breakdown.",
        ...
        ctk.CTkLabel(center, text="Economics Module", font=Fonts.H1,
        ...
        ctk.CTkLabel(center,
                     text="Complete financial analysis toolkit for\nwind-powered desalination projects.",
                     font=Fonts.BODY, text_color=Colors.TEXT_SECONDARY,
                     justify="center").pack(pady=(0, Spacing.PAD_XL))

        features = ctk.CTkFrame(center, fg_color="transparent")
        features.pack()
        for feat in ["Levelized Cost of Water (LCOW)", "CAPEX & OPEX Breakdown",
                     "Net Present Value Analysis", "Sensitivity & Monte Carlo"]:
